...
// GET THE CONDITIONS
weatherConditions.open('GET', 'http://api.openweathermap.org/data/2.5/weather?q=malmö,se&appid=e1137668a5448f4742c53b5e6df862cb&units=metric', true);
...
// GET THE FORECARST
weatherForecast.open('GET', 'http://api.openweathermap.org/data/2.5/forecast?q=malmö,se&appid=e1137668a5448f4742c53b5e6df862cb&units=metric', true);
